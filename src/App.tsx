    ...
    <>
      <main>
        <div className="grid">
          <div className="turn">
            <img
              src={game.currentPlayer.iconSrc}
              alt={game.currentPlayer.iconAlt}
              className="img-label"
            />
          ...
          <Actions onAction={(action) => resetGame(action === "new-round")} />
          ...
          {[1, 2, 3, 4, 5, 6, 7, 8, 9].map((squareId) => {
            ...
            return (
              ...
              >
                {existingMove && (
                  <img
                    src={existingMove.player.iconSrc}
                    alt={existingMove.player.iconAlt}
                  />
                )}
              </div>
            );
